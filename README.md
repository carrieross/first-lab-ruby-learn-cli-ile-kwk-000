...
4. To pass this lab, make any change to the content of the `edit-me.txt` file. You can do this by clicking on the name of the file in the file browser, in the left pane; its contents will load in the text editor. Type in the text editor to change the contents of the file, then save your changes.
